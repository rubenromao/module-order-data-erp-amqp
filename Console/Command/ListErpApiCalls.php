...
class ListErpApiCalls extends Command
{
    ...
    /**
     * @var \Rubenromao\ErpApiRequests\Api\ErpApiRequestsRepositoryInterface
     */
     ...
     *
     * @param \Rubenromao\ErpApiRequests\Api\ErpApiRequestsRepositoryInterface $erpApiRequestsRepository
     * @param SearchCriteriaBuilder $searchCriteriaBuilder
     * @param Filter $filter
     * @param SortOrder $sortOrder
     */
    public function __construct(
        \Rubenromao\ErpApiRequests\Api\ErpApiRequestsRepositoryInterface $erpApiRequestsRepository,
